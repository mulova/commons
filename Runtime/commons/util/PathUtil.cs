...
namespace mulova.commons
{
	public static class PathUtil
	{
		...
		public static string ReplaceExtension(string src, string ext)
		{
            ...
            int dotIndex = src.LastIndexOf(".", StringComparison.Ordinal);
			if (dotIndex >= 0)
			{
		...
		public static string GetDirectory(string src)
		{
			...
			int slashIndex = src.LastIndexOf("/", StringComparison.Ordinal);
			if (slashIndex >= 0)
			{
		...
		public static string GetLastDirectory(string src)
		{
			...
			int slashIndex = src.LastIndexOf("/", endIndex-1, StringComparison.Ordinal);
			if (slashIndex >= 0)
			{
		...
		{
			int slashIndex = src.LastIndexOf("/", StringComparison.Ordinal) +1;
			int dotIndex = src.LastIndexOf(".", StringComparison.Ordinal);
			if (dotIndex >= 0)
			{
		...
		public static string GetRelativePath(string fullPath, string parent)
		{
			...
			if (fullPath.StartsWith(parent, StringComparison.Ordinal))
			{
