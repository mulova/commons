...
namespace System.Ex
{
	public static class DateTimeEx
	{
		...
		public static bool IsOver(this DateTime d)
		{
			var now = d.Kind == DateTimeKind.Utc ? DateTime.UtcNow : DateTime.Now;
			return d.Ticks - now.Ticks <= 0;
		}

		public static TimeSpan GetRemains(this DateTime time)
		{
