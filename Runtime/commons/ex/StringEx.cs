...
namespace System.Text.Ex
{
    ...
    {
        public static readonly ILog log = LogManager.GetLogger(typeof(string));
        ...
        public static string Format(this string str, object arg1, object arg2)
        {
            return string.Format(str, arg1, arg2);
        }
        
        public static string Format(this string str, object arg1, object arg2, object arg3)
        {
        ...
        public static bool IsURL(this string str)
        {
            ...
            return str.StartsWith("file:///", StringComparison.Ordinal)
                      ||str.StartsWith("http://", StringComparison.Ordinal)
                      ||str.StartsWith("https://", StringComparison.Ordinal)
                      ||str.StartsWith("ftp://", StringComparison.Ordinal);
        }
        ...
        public static bool EqualsIgnoreCaseSeparator(this string str1, string str2)
        {
            return EqualsIgnore(str1, str2, (c1, c2) => char.ToLower(c1) == char.ToLower(c2) || (c1 == '/' && c2 == '\\') || (c1 == '\\' && c2 == '/'));
        }
        ...
        {
            return path != null&&(path.Contains("/Resources/")||path.StartsWith("Resources/", StringComparison.Ordinal));
        }
        ...
        {
            int startIndex = 0;
            if (path.StartsWith("Resources/", StringComparison.Ordinal))
            {
        ...
        public static string GetLastFolderName(this string folderPath)
        {
            ...
            int index = path.LastIndexOf("/", path.Length-2, StringComparison.Ordinal);
        ...
        */
        ...
        {
            byte[] hashBytes = new SHA1Managed().ComputeHash(Encoding.UTF8.GetBytes(s));
