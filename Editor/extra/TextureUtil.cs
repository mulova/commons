namespace mulova.unicore
{
    ...
    public static class TextureUtil
    {
        ...
        {
			string srcStr = src.ConvertAll(s=>s.WrapWhitespacePath()).Join(" ");
...
//          Exec("convert", src, rgb, "-background \"#000000\" -alpha remove");
        ...
        public static (int width, int height) GetImageSize(string assetPath)
        {
        ...
        public static (int width, int height) GetImageSize(AssetImporter im)
        {
