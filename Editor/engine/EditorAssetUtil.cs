...
namespace mulova.unicore
{
    ...
    public static class EditorAssetUtil
    {
        ...
        public static void SetTextureImportProperty(string assetPath, TextureImporterType textureType, TextureImporterNPOTScale scale, bool mipmap, bool readable)
        {
        ...
        {
            return ListAssetPaths(assetPath, fileType.GetExt(), assetsRelative);
        }


        public static string[] ListAssetPaths(string assetPath, string[] exts = null, bool assetsRelative = false)
        {
            ...
            foreach (string ext in exts)
            {
                ...
                for (int i = 0; i < files.Length; i++)
                {
                    ...
                    int index = srcPath.IndexOf(Application.dataPath, StringComparison.Ordinal);
                    if (assetsRelative)
                    {
