...
{
    public class StrPropertyReorder : PropertyReorder<string>
    {
        public bool editable;

        public StrPropertyReorder(SerializedObject ser, string varName, bool editable = true) : base(ser, varName)
        {
